...
const FloatingWhatsApp = () => {
  return (
    <motion.a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center gap-3 h-12 pl-4 pr-5 rounded-full border border-primary/20 bg-card/80 backdrop-blur-xl active:scale-[0.96] transition-all duration-300 hover:border-primary/40 hover:shadow-[0_4px_24px_-4px_hsla(52,100%,50%,0.15)]"
